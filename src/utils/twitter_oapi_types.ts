...
export type searchStreamAnnotation = (components['schemas']['EntityIndicesInclusiveInclusive'] & {
  normalized_text?: string;
  probability?: number;
  type?: string;
})
// export type searchStreamCashtags = components['schemas']['CashtagEntity'];
export type searchStreamHashtag = components['schemas']['HashtagEntity'];
export type searchStreamMention =  components['schemas']['MentionEntity'];
export type searchStreamUrl = components['schemas']['UrlEntity'];
